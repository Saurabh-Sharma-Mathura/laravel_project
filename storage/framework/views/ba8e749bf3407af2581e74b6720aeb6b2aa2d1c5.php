        ...
        <div class="p-6">
            <a href="<?php echo e(route('task.index')); ?>"
               ...
               <button
                ...
                <i class="fas fa-plus mr-3"></i><a href="<?php echo e(route('task.create')); ?>">New Task</a>
            </button>
            <?php endif; ?>
        ...
        <nav class="text-white text-base font-semibold pt-3">
            ...
            <?php if(auth()->guard()->check()): ?>
                <?php if(Auth::user()->admin): ?>
                   <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center  text-white py-4 pl-6 nav-item">
                    <i class="fas fa-tachometer-alt mr-3"></i>
                    Admin Dashboard
                    </a> 
                     <a href="/user/<?php echo e(auth()->id()); ?>/dashboard" class="flex items-center text-white py-4 pl-6 nav-item">
                    <i class="fas fa-user mr-3"></i>
                    <?php echo e(ucwords(auth()->user()->name)); ?>'s Dashboard
                </a>
                <?php endif; ?>
    ...
    <div class="w-full flex flex-col h-screen overflow-y-hidden">
            ...
            <?php if(auth()->guard()->check()): ?>
                <div x-data="{ isOpen: false }" class="relative w-1/2 flex justify-end">
                    ...
                    <div x-show="isOpen" class="absolute w-25 bg-white rounded-lg shadow-lg py-2 mt-6">
                          <?php if(Auth::user()->admin): ?>
                        <a href="/user/<?php echo e(auth()->id()); ?>/dashboard" class="block px-4 py-2 account-link hover:text-white">
                            Account
                        </a>
                        <?php endif; ?>
        ...
        <div class="w-full overflow-x-hidden border-t flex flex-col">
            ...
            <footer class="w-full bg-white text-right p-4">
                Built by <a target="_blank" href="#" class="underline">Saurabh Sharma</a>.
            </footer>
        </div>
...
<?php /**PATH C:\xampp\htdocs\carziro\laravel21\resources\views/components/layout.blade.php ENDPATH**/ ?>